import { getCategories, updateCategory, deleteCategory, createCategory } from './../services/categoryService.js';

document.addEventListener('DOMContentLoaded', () => {
    const tableBody = document.querySelector('#categoriesTable tbody');
    const form = document.querySelector('#categoryForm');
    const modal = new bootstrap.Modal(document.querySelector('#categoryModal'));
    const lbModal = document.querySelector('#categoryModalLabel');
    const btnAdd = document.querySelector('#btnAddCategory');
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            console.error('[categoryController.js] Error al guardar la categoría: ', err);
        }
    });
    ...
    async function loadCategories() {
        try {
            ...
            console.error('[categoryController.js] Error al cargar las categorías: ', err);
        }
    }
});